...
const clientNavTree = [
  {
    key: "clien",
    path: `${APP_PREFIX_PATH}/clients/ClientsInfo`,
    title: "Clients",
    icon: TeamOutlined,
    breadcrumb: false,
    submenu: [],
...
const projectNavTree = [
  {
    key: "project",
    path: `${APP_PREFIX_PATH}/projects/ProjectsInfo`,
    title: "Projects",
...
const technologyNavTree = [
  {
    key: "technology",
    path: `${APP_PREFIX_PATH}/technology/technology`,
    title: "Technology",
...
const developersNavTree = [
  {
    key: "developers",
    path: `${APP_PREFIX_PATH}/developers/DevelopersAdd`,
    title: "Developers",
    icon: RobotOutlined,
    breadcrumb: false,
    submenu: [],
...
const platformNavTree = [
  {
    key: "platform",
    path: `${APP_PREFIX_PATH}/platform/PlatformAdd`,
    title: "Platform",
    icon: DesktopOutlined,
    breadcrumb: false,
    submenu: [],
